...
const imageUrls = {
    ...
    fitness: '/dodgy-dodger/blob/main/FitnessBro.png', // Replace with actual image URL for Fitness Influencer
    crypto: '/dodgy-dodger/blob/main/CryptoBro.png' // Replace with actual image URL for Crypto Bro
};
